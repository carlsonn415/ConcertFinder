...
import com.example.concertfinder.model.apidata.AccessData
import com.example.concertfinder.model.apidata.Classification
import com.example.concertfinder.model.apidata.EmbeddedEventData
import com.example.concertfinder.model.apidata.Event
import com.example.concertfinder.model.apidata.Place
import com.example.concertfinder.model.apidata.PriceRange
import com.example.concertfinder.model.apidata.Status
import com.example.concertfinder.model.apidata.Venue
...
private fun EventDetailsScreenPreview() {
    EventDetailsScreen(
        event = Event(
            embedded = EmbeddedEventData(
                venues = listOf(
                    Venue(
                        ...
                        images = listOf(
                            com.example.concertfinder.model.apidata.EventImage(
                                url = "https://example.com/image.jpg",
                                ratio = "16:9",
                            )
                        ),
                        additionalInfo = "Additional info",
                        address = com.example.concertfinder.model.apidata.Address(
                            line1 = "123 Main St",
                        ),
                        city = com.example.concertfinder.model.apidata.City(
                            name = "Anytown",
                        ),
                        state = com.example.concertfinder.model.apidata.State(
                            name = "CA",
                            ),
                        parkingDetail = "Parking info",
                        generalInfo = com.example.concertfinder.model.apidata.GeneralInfo(
                ...
                attractions = listOf(
                    com.example.concertfinder.model.apidata.Attraction(
                        id = "123",
                        ...
                        classifications = listOf(
                            Classification(
                                segment = com.example.concertfinder.model.apidata.Segment(
                                    name = "Test Segment",
                                    id = "123",
                                ),
                                genre = com.example.concertfinder.model.apidata.Genre(
                                    name = "Test Genre",
                                    id = "123",
                                ),
                                subGenre = com.example.concertfinder.model.apidata.SubGenre(
                                    name = "Test SubGenre",
                                    id = "123",
                                ),
                            )
            ...
            id = "123",
            name = "Test Event",
            location = com.example.concertfinder.model.apidata.LocationData(
                latitude = 12.34,
                longitude = 56.78
            ),
            url = "https://example.com",
            ...
            additionalInfo = "Additional info",
            dates = com.example.concertfinder.model.apidata.DateData(
                start = com.example.concertfinder.model.apidata.StartData(
                ...
                end = com.example.concertfinder.model.apidata.EndData(
                    localDate = "2023-09-15",
                    localTime = "12:00:00",
                    noSpecificTime = false,
                    approximate = false
                ...
                status = com.example.concertfinder.model.apidata.StatusData(
